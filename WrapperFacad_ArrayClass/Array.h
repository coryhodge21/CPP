...
#include <stdexcept>        // throw std:: out_of_range(" message ");
...
public:
     ...
     */
    Array(std:: size_t length, char fill);
 ...
 */
     ...
     * @exception       std::out_of_range     Invalid \a index value
     */
    bool set(size_t index, char value);
    ...
    /// Need Public for Testing:  cycle through array and display elements values
    void displayArray();
